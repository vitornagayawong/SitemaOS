...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    private void emitir_os() {
        ...
        try {
            ...
            if (txtCliId.getText().isEmpty() || txtOsEquip.getText().isEmpty() || txtOsDef.getText().isEmpty()) {
                ...
                int adicionado = pst.executeUpdate(); // se executar o update ele retorna 1
                if (adicionado > 0) {
    ...
    private void alterar_os() {
        ...
        try {
            ...
            if (txtCliId.getText().isEmpty() || txtOsEquip.getText().isEmpty() || txtOsDef.getText().isEmpty()) {
                ...
                int adicionado = pst.executeUpdate(); // se executar o update ele retorna 1
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "OS alteradaa com sucesso");
                    txtCliId.setText(null);
                    txtOsEquip.setText(null);
                    txtOsDef.setText(null);
                    txtOsServ.setText(null);
    ...
    private void initComponents() {
        ...
        rbtOs.setText("Ordem se serviço");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/ic_search_icon.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/ic_search_icon.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/deletar.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/print_printer_icon.png"))); // NOI18N
    ...
    private void tblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientesMouseClicked
        // Tchamando o método setar_campos
        setar_campos();
    }//GEN-LAST:event_tblClientesMouseClicked

    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        // atribuindo um texto à variável tipo selecionada
        tipo = "Orçamento";
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // ao abrir o form, ele marca o radio button Orçamento
        rbtOrc.setSelected(true);
        tipo = "Orçamento";
